...
export default function SettingsPage() {
  ...
  return (
    <div
      style={{ padding: "36px 40px", minHeight: "100%", background: "#FFFEF0" }}
    >
          ...
          {[
            ...
            <button
              ...
              style={{
                ...
                gap: "12px",
                padding: "16px",
                background: t.active ? "#0047FF" : "transparent",
                color: t.active ? "#FFFEF0" : "#555",
                border: "none",
                borderBottom: i < 4 ? "2px solid #E8E8E0" : "none",
                textAlign: "left",
                cursor: "pointer",
              }}
            >
              ...
              <span
                style={{ fontSize: "13px", fontWeight: t.active ? 800 : 600 }}
              >
                {t.l}
              </span>
            </button>
